...
export const AboutProvider = ({ children }) => {
  ...
  const aboutData = {
    ...
    techSkills: ["JavaScript", "React", "Ruby", "Ruby on Rails", "HTML", "CSS", "WordPress", "Design", "UI/ UX"],
    softSkills: ["Skilled Communicator", "Leadership", "Magagement", "Organization", "Problem-Solving/ Adaptability", "Collaboration"]
  };
